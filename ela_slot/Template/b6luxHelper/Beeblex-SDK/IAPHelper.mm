...
{
    if ([identifier_ isEqualToString:kIAP_I_COINS_1_99])        {[self updateDB:d_Coins num:1050];}
    else if ([identifier_ isEqualToString:kIAP_I_COINS_4_99])   {[self updateDB:d_Coins num:4400];}
    else if ([identifier_ isEqualToString:kIAP_I_COINS_9_99])   {[self updateDB:d_Coins num:17250];}
    else if ([identifier_ isEqualToString:kIAP_I_COINS_19_99])  {[self updateDB:d_Coins num:52000];}
    else if ([identifier_ isEqualToString:kIAP_I_COINS_49_99])  {[self updateDB:d_Coins num:217500];}
    else if ([identifier_ isEqualToString:kIAP_I_COINS_99_99])  {[self updateDB:d_Coins num:612500];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST2X_1_99]) {[self updateDB:d_Boost2x num:20];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST2X_2_99]) {[self updateDB:d_Boost2x num:40];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST2X_3_99]) {[self updateDB:d_Boost2x num:60];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST2X_4_99]) {[self updateDB:d_Boost2x num:80];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST3X_2_99]) {[self updateDB:d_Boost3x num:20];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST3X_4_99]) {[self updateDB:d_Boost3x num:40];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST3X_6_99]) {[self updateDB:d_Boost3x num:80];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST3X_8_99]) {[self updateDB:d_Boost3x num:100];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST4X_6_99]) {[self updateDB:d_Boost4x num:40];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST4X_8_99]) {[self updateDB:d_Boost4x num:80];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST4X_14_99]){[self updateDB:d_Boost4x num:100];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST4X_19_99]){[self updateDB:d_Boost4x num:120];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST5X_14_99]){[self updateDB:d_Boost5x num:80];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST5X_24_99]){[self updateDB:d_Boost5x num:100];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST5X_34_99]){[self updateDB:d_Boost5x num:150];}
    else if ([identifier_ isEqualToString:kIAP_I_BOOST5X_49_99]){[self updateDB:d_Boost5x num:250];}
